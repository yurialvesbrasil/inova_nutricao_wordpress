...
?>
	...
	public function render_title() {
		...
		printf('<%1$s class="upk-title"><a href="%2$s" title="%3$s" class="upk-ramble-title">%3$s</a></%1$s>', Utils::get_valid_html_tag($settings['title_tags']), get_permalink(), get_the_title());
	}
